...
// MAGIC %python
// MAGIC parquetDir = source + "/wikipedia/pagecounts/staging_parquet_en_only_clean/"

// COMMAND ----------

// MAGIC %python
// MAGIC pagecountsEnAllDF = (spark  # Our SparkSession & Entry Point
// MAGIC   .read                     # Our DataFrameReader
// MAGIC   .parquet(parquetDir)      # Returns an instance of DataFrame
// MAGIC )
// MAGIC print(pagecountsEnAllDF)    # Python hack to see the data type
...
// MAGIC %python
// MAGIC total = pagecountsEnAllDF.count()
// MAGIC 
// MAGIC print("Record Count: {0:,}".format( total ))
