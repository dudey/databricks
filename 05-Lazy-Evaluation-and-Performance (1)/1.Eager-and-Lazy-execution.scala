...
// MAGIC %python
// MAGIC schemaDDL = "NAME STRING, STATION STRING, LATITUDE FLOAT, LONGITUDE FLOAT, ELEVATION FLOAT, DATE DATE, UNIT STRING, TAVG FLOAT"
// MAGIC 
// MAGIC sourcePath = "/mnt/training/weather/StationData/stationData.parquet/"
// MAGIC 
// MAGIC countsDF = (spark.read
// MAGIC   .format("parquet")
// MAGIC   .schema(schemaDDL)
// MAGIC   .load(sourcePath)
// MAGIC   .groupBy("NAME", "UNIT").count()
// MAGIC   .withColumnRenamed("count", "counts")
// MAGIC   .orderBy("NAME")
// MAGIC )
