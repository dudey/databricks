...
val customerAddressSchema = "ca_address_sk LONG,ca_address_id STRING,ca_street_number STRING,ca_street_name STRING,ca_street_type STRING,ca_suite_number STRING,ca_city STRING,ca_county STRING,ca_state STRING,ca_zip STRING,ca_country STRING,ca_gmt_offset decimal(5,2),ca_location_type STRING"

// COMMAND ----------

val customerDemographicsSchema = "cd_demo_sk LONG,cd_gender STRING,cd_marital_status STRING,cd_education_status STRING,cd_purchase_estimate INT,cd_credit_rating STRING,cd_dep_count INT,cd_dep_employed_count INT,cd_dep_college_count INT"

// COMMAND ----------

val householdDemographicsSchema = "hd_demo_sk LONG,hd_income_band_sk LONG,hd_buy_potential STRING,hd_dep_count INT,hd_vehicle_count INT"

// COMMAND ----------

val incomeBandSchema = "ib_income_band_sk LONG,ib_lower_bound INT,ib_upper_bound INT"
...
val promotionSchema = "p_promo_sk LONG,p_promo_id STRING,p_start_date_sk LONG,p_end_date_sk LONG,p_item_sk LONG,p_cost decimal(15,2),p_response_target INT,p_promo_name STRING,p_channel_dmail STRING,p_channel_email STRING,p_channel_catalog STRING,p_channel_tv STRING,p_channel_radio STRING,p_channel_press STRING,p_channel_event STRING,p_channel_demo STRING,p_channel_details STRING,p_purpose STRING,p_discount_active STRING"

// COMMAND ----------

val reasonSchema = "r_reason_sk LONG,r_reason_id STRING,r_reason_desc STRING"

// COMMAND ----------

val shipModeSchema = "sm_ship_mode_sk LONG,sm_ship_mode_id STRING,sm_type STRING,sm_code STRING,sm_carrier STRING,sm_contract STRING"

// COMMAND ----------

val timeDimSchema = "t_time_sk LONG,t_time_id STRING,t_time INT,t_hour INT,t_minute INT,t_second INT,t_am_pm STRING,t_shift STRING,t_sub_shift STRING,t_meal_time STRING"
