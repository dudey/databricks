...
// MAGIC %python
// MAGIC mounts = dbutils.fs.mounts()
// MAGIC 
// MAGIC for mount in mounts:
// MAGIC   print(mount.mountPoint + " >> " + mount.source)
// MAGIC 
// MAGIC print("-"*80)
...
// MAGIC %python
// MAGIC files = dbutils.fs.ls("/mnt/training/")
// MAGIC 
// MAGIC for fileInfo in files:
// MAGIC   print(fileInfo.path)
// MAGIC 
// MAGIC print("-"*80)
